INSERT INTO race (name,str_bonus,dex_bonus,int_bonus,const_bonus,wis_bonus,cha_bonus)
	VALUES
		('AARAKOCRA',2,0,0,0,0,2),
		('AASIMAR',2,0,0,0,0,2),
		('AETHERBORN',2,0,0,0,0,2),
		('BUGBEAR',2,0,0,0,0,2),
		('CENTAUR',2,0,0,0,0,2),
		('CHANGELING',2,0,0,0,0,2),
		...
		('GNOME',2,0,0,0,0,2),	
		('GOLIATH',2,0,0,0,0,2),
		('HALF-ELF',2,0,0,0,0,2),
		('HALF-ORC',2,0,0,0,0,2),
		('HALFLING',2,0,0,0,0,2),
		('HIGH-ELF',0,2,0,0,0,0),
