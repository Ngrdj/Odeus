INSERT INTO init (label)
    VALUES
                ('Alors qu''ils traversent une contrée sauvage, les personnages chutent au travers d''une doline qui s''ouvre sous leurs pied et atterrissent sur le site de l''aventure'),
...
INSERT INTO enemy (label)
    VALUES
        ('Un animal ou une monstruosite sans intention cachée particulière'),
...
INSERT INTO bonus (label)
    VALUES
        ('Trouver un objet spéciﬁque qui, semble-t-il, se trouve dans les environs.'),
...
INSERT INTO context (label)
    VALUES
        (' Anniversaire du couronnement d''un monarque'),
...
INSERT INTO twist (label)
    VALUES
        ('Les aventuriers et d''autres créatures se précipitent pour atteindre un objectif identique ou opposé.'),
